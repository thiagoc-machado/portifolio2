...
const Data = () => {
    return (
        <div className="home__data">
            ...
            >
                <span className="home__meta-label">Now</span>
                <h4 className="home__meta-title">GHENOVA Digital</h4>
                <p className="home__meta-text">
                    Building geospatial and data platforms with Django,
                    PostGIS, MinIO, Keycloak, Airflow and Azure DevOps.
                </p>
                <div className="home__meta-tags">
                    <span>Django</span>
                    <span>PostGIS</span>
                    <span>Airflow</span>
