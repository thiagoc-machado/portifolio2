...
const Services = () => {
    ...
    const prevMagis = () =>
        setMagisSlide(
            (prev) => (prev - 1 + magisImages.length) % magisImages.length,
        );
                ...
                <div className="services__featured-wrap">
                    ...
                    >
                        <div className="services__featured-copy">
                            <p className="services__featured-kicker">
                                Flagship product
                            </p>
                    ...
                    >
                        <div className="services__modal-content services__modal-content-wide">
                            ...
                            <p className="services__modal-description">
                                ...
                                kitchen/KDS workflows, and a centralized admin
                                layer for menus, tables, users, and promotions.
                            ...
                            <ul className="services__modal-services grid">
                                ...
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                                    <p className="services__modal-info">
                                        Kitchen and status screens with live
                                        order states delivered through
                                        WebSockets.
                                    </p>
                                </li>
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                                    <p className="services__modal-info">
                                        Multi-tenant admin for menus,
                                        promotions, tables, users, and auditing,
                                        deployed with Docker and Nginx on AWS.
                                    </p>
                                </li>
                            </ul>
                        </div>
                ...
                >
                    <div className="services__card-secondary-inner">
                        ...
                        >
                            ...
                            <p className="services__mini-description">
                                ...
                                employees, work orders, and cash control.
                            </p>
                            <span
                    ...
                    >
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                Full management system for service companies,
                                covering customer registration, users, services,
                                employees, work orders, and cash control. I
                                built it with Django, Python, JavaScript, and
                                Bootstrap to streamline day-to-day operations
                ...
                >
                    <div className="services__card-secondary-inner">
                        ...
                        >
                            ...
                            <p className="services__mini-description">
                                Clean, responsive landing page focused on
                    ...
                    >
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                Landing page for an appliance maintenance
                                company, built with HTML, CSS, and JavaScript.
                                The focus was on clear messaging, simple
                                navigation, and a responsive layout that works
                                well on every screen size.
                            </p>
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    <i className="uil uil-globe services__modal-icon"></i>
                ...
                >
                    <div className="services__card-secondary-inner">
                        ...
                        >
                            ...
                            <p className="services__mini-description">
                                Practice tool for CAP exam prep with randomized
                                questions and local progress tracking.
                            </p>
                            <span
                                onClick={() => toggleTab(3)}
                                className="services__button"
                    ...
                    >
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                Web application for CAP exam preparation in
                                Spain. It collects questions from the Spanish
                                Ministry of Transport, presents them in a
                                randomized study flow, and stores progress
                                locally in the browser. The project is still
                                evolving, but the core learning experience is
                                already in place.
                            </p>
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                ...
                >
                    <div className="services__card-secondary-inner">
                        ...
                        >
                            ...
                            <p className="services__mini-description">
                                React player with Shazam API integration,
                                search, playback and lyrics.
                            </p>
                            <span
                                onClick={() => toggleTab(4)}
                                className="services__button"
                    ...
                    >
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                React music player built around the Shazam API
                                via RapidAPI and styled with Tailwind CSS. It
                                includes search, playback, lyrics, artist
                                details, and location-aware recommendations.
                            </p>
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    <i className="uil uil-globe services__modal-icon"></i>
                ...
                >
                    <div className="services__card-secondary-inner">
                        ...
                        >
                            ...
                            <p className="services__mini-description">
                                Flask ordering flow for a restaurant with
                                kitchen screen and order tracking.
                            </p>
                            <span
                                onClick={() => toggleTab(5)}
                                className="services__button"
                    ...
                    >
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                Web app built with Python and Flask to simplify
                                the ordering process for a Chinese restaurant.
                                It includes a customer flow, a kitchen screen,
                                SQLite persistence, recurring-order discounts,
                ...
                >
                    <div className="services__card-secondary-inner">
                        ...
                        >
                            ...
                            <p className="services__mini-description">
                                Dashboard connected to Google Sheets for simple,
                                spreadsheet-driven updates.
                            </p>
                            <span
                                onClick={() => toggleTab(6)}
                                className="services__button"
                    ...
                    >
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                React dashboard integrated with Google Sheets,
                                letting data updates happen directly from the
                                spreadsheet while keeping the dashboard in sync.
                            </p>
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    <i className="uil uil-globe services__modal-icon"></i>
